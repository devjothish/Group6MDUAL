...
public class QueryGenerator1 {
    ...
    public static void main(String[] args) {
        QueryConfig config = new QueryConfig("STK", 10000, 500, 50, 5);
        QueryGenerator generator = new QueryGenerator(config);
        String filePath = "Generatedqueryset/queries.csv";
        generator.generateAndSaveQueries(100, new String[]{"R", "K", "S", "W"}, filePath);
    }
}
